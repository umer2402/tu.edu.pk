                                            ...
                                            <ul class="sub-menu">
                                                <li class="has-children"><a class="active" href="#">SHOP LAYOUT</a>
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li><a class="active" href="shop-right-sidebar.html">SHOP RIGHR SIDEBAR</a></li>
                        ...
                        <div class="sidebar">
                            <div class="sidebar-widget category-widget">
                                ...
                                <ul class="product-category-list">
                                    <li class="has-subcat">
                                        <a class="active" href="javascript:void(0)">Business <span>2</span></a>
                                        <ul class="subcategory">
                                            <li><a href="product-details.html">Business Math</a></li>
                                            <li><a href="product-details.html">Business Communication</a></li>
                                        </ul>
                                    </li>
                                    <li class="has-subcat">
