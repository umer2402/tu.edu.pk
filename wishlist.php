    ...
    <div class="page-wrapper">
        ...
        <section class="wishlist-wrap ptb-100">
            <div class="container">
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td><a href="shop-details.html">Forrester</a></td>
                                        <td>
                                            <p class="wh-tem-price">$48.00</p>
                                        </td>
                                        <td>
                                            <div class="wh_qty">
                                                <div class="product-quantity">
                                        ...
                                        <td>
                                            <p class="wh-tem-price text-red">$48.00</p>
                                        </td>
                                        <td>
                                            <button type="button" class="text-orange">Add to cart</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                        ...
                                        <td>
                                            <a href="shop-details.html">Business Report</a>
                                        </td>
                                        <td>
                                            <p class="wh-tem-price">$28.00</p>
                                        </td>
                                        <td>
                                            <div class="wh_qty">
                                                <div class="product-quantity">
                                        ...
                                        <td>
                                            <p class="wh-tem-price text-red">$28.00</p>
                                        </td>
                                        <td>
                                            <button type="button" class="text-orange">Add to cart</button>
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="shop-details.html">Today's English</a>
                                        </td>
                                        <td>
                                            <p class="wh-tem-price">$30.00</p>
                                        </td>
                                        <td>
                                            <div class="wh_qty">
                                                <div class="product-quantity">
                                        ...
                                        <td>
                                            <p class="wh-tem-price text-red">$30.00</p>
                                        </td>
                                        <td>
                                            <button type="button" class="text-orange">Add to cart</button>
                                        </td>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <a href="shop-left-sidebar.html" class="btn v3">Continue Shopping</a>
                    </div>
                    <div class="col-sm-6 text-sm-end">
                        <a href="checkout.html" class="btn v7">Proceed To Checkout</a>
                    </div>
                </div>
            </div>
        </section>
