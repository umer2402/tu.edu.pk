    ...
    <div class="page-wrapper">
       ...
       ?>
        ...
        <div class="post-details pt-100 pb-100">
            <div class="container">
                <div class="row gx-5">
                    <div class="col-xl-4 col-lg-4 order-xl-1 order-lg-2 order-md-2 order-2">
                        <div class="sidebar">
                        ...
                        <div class="content-wrapper">
                            <article>
                                <div class="post-content ">
                                    ...
                                    <h2 class="post-subtitle">Online learning is not the next big thing, it is the now big thing</h2>
                                    ...
                                    <p class="mb-0">Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum. Claritas est etiam processus dynamicus, qui sequitur mutationem consuetudium lectorum eleifend option.</p>
                                </div>
                            </article>
                            ...
                            <div class="post-comment-wrap style2">
                                ...
                                <div class="comment-item">
                                    <div class="comment-author_img">
                                        <img src="assets/img/team/team-member-6.jpg" alt="Image">
                                    </div>
                                    <div class="comment-author_text">
                                        <div class="comment-author_info">
                                            <h6>Mira Brox</h6>
                                            <p>15 Feb, <script src="assets/js/fslightbox.js"></script> AT 02:00 PM</p>
                                        </div>
                                ...
                                <div class="comment-item reply">
                                    ...
                                    <div class="comment-author_text">
                                        <div class="comment-author_info">
                                            ...
                                            <p>7:00 PM, 21 January, <script src="assets/js/fslightbox.js"></script></p>
                                        </div>
                            ...
                            <div class="comment-form-wrap">
                                ...
                                <form action="#" class="comment-form style2">
                                    <div class="row gx-3">
                                        <div class="col-lg-6">
