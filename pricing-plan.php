...
<body>
    ...
    <div class="page-wrapper">
                                    ...
                                    <ul class="main-menu ">
                                        ...
                                        <li class="has-children"><a class="active" href="#">PAGES</a>
                                            <ul class="sub-menu">
                                                ...
                                                <li><a  class="active" href="pricing-plan.html">PRICING PLAN</a></li>
        ...
        <section class="Pricing-section pt-100 pb-100">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="pricing-box-wrap style1">
                            <div class="pricing-box">
                                <h5 class="pricing-box-name">Basic</h5>
                                <div class="price-tag">
                                    <h3>$29.99 <span>/per month</span></h3>
                                </div>
                                <ul class="price-box-features">
                                    <li><i class="las la-check"></i>Unlimited file recovery</li>
                                    <li><i class="las la-check"></i>Professional reports</li>
                                    <li class="text-decoration-line-through"><i class="las la-check"></i>Sell on marketplaces</li>
                                    <li class="text-decoration-line-through"><i class="las la-check"></i>24/7 free support</li>
                                </ul>
                                <div class="book-btn">
                                    <a class="btn v3" href="pricing-plan.html">Book Now</a>
                                </div>
                            </div>
                            <div class="pricing-box active">
                                <h5 class="pricing-box-name">Professional</h5>
                                <div class="price-tag">
                                    <h3>$39.99 <span>/per month</span></h3>
                                </div>
                                <div class="price-box-features">
                                    <ul class="">
                                        <li><i class="las la-check"></i>Unlimited file recovery</li>
                                        <li><i class="las la-check"></i>Professional reports</li>
                                        <li><i class="las la-check"></i>Sell on marketplaces</li>
                                        <li class="text-decoration-line-through"><i class="las la-check"></i>24/7 free support</li>
                                    </ul>
                                </div>
                                <div class="book-btn">
                                    <a class="btn v4" href="pricing-plan.html">Book Now</a>
                                </div>
                            </div>
                            <div class="pricing-box">
                                <h5 class="pricing-box-name">Business</h5>
                                <div class="price-tag">
                                    <h3>$49.99 <span>/per month</span></h3>
                                </div>
                                <ul class="price-box-features">
                                    <li><i class="las la-check"></i>Unlimited file recovery</li>
                                    <li><i class="las la-check"></i>Professional reports</li>
                                    <li><i class="las la-check"></i>Sell on marketplaces</li>
                                    <li><i class="las la-check"></i>24/7 free support</li>
                                </ul>
                                <div class="book-btn">
                                    <a class="btn v3" href="pricing-plan.html">Book Now</a>
                                </div>
