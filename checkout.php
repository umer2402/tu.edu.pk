                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone" id="phone" placeholder="Enter Phone Numnber" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="state" id="state" placeholder="USA" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <label for="zip">ZIP Code*</label>
                                        <input type="text" name="zip" id="zip" placeholder="USA" required>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="checkout-details smt-30">
                            ...
                            <div class="col-lg-12 mt-3">
                                <button type="button" class="btn v3">Palce Order</a>
                            </div>
                        </div>
                    </div>
                </div>
