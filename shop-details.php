    ...
    <div class="page-wrapper">
                                    ...
                                    <ul class="main-menu ">
                                        ...
                                        <li class="has-children">
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <li><a class="active" href="shop-details.html">SHOP DETAILS</a></li>
        ...
        <section class="product-details-wrap pt-100">
            <div class="container">
                <div class="row gx-5 ">
                    <div class="col-lg-6">
                        <div class="product-gal_wrap">
                            <div class="swiper-container gallery-top">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide">
                                        <div class="product-large-img">
                                            <span class="discount-price">30% Off</span>
                                            <img src="assets/img/product/single-product-1.png" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="single-product-details">
                            ...
                            <div class="single-product-desc">
                                <p>
                                    Lorem ipsum, dolor sit, amet consectetur adipisicing elit. Ipsum non facilis corporis modi consequatur. Iure perferendis dicta illum deleniti veritatis vero tempora maxime ducimus quaerat, iusto omnis magni doloribus. Repellat exercitationem odio rerum doloremque quod, enim iste doloribus fugit incidunt suscipit, totam illo molestias! Beatae error reprehenderit autem ex sit laudantium praesentium quibusdam optio, ab omnis magnam nobis quisquam enim ad sint? Error soluta exercitationem earum atque vel porro? Quam exercitationem expedita velit explicabo aspernatur culpa
                                </p>
                            </div>
                            <ul class="rating">
                            ...
                            <div class="product-more-option">
                                <div class="product-more-option-item">
                                    <h6>Category :</h6>
                                    <a class="text-orange" href="shop-left-sidebar.html">Uncatagorized</a>
                                </div>
                                <div class="product-more-option-item">
                                    <h6>Quantity:</h6>
                                    <div class="product-quantity">
                            ...
                            <div class="single-product-option">
                                    <button type="submit" class="btn v1"><span>Buy Now</span></button>
                                    <button type="button" class="btn v1"><span>Add To Cart </span></button>
                            </div>
                            <div class="product-more-option">
                                <div class="product-more-option-item">
                                    <h6>Share On :</h6>
                ...
                <div class="row pt-100 mmt-20">
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs product-tablist" role="tablist">
                            ...
                            <li class="nav-item">
                                <button class="nav-link " data-bs-toggle="tab" data-bs-target="#tab_2" type="button" role="tab">Reviews</button>
                            </li>
                        </ul>
                        <div class="tab-content product-tab-content">
                            <div class="tab-pane fade show active" id="tab_1" role="tabpanel">
                                <div class="product_desc">
                                    <p>Lorem ipsum, dolor sit, amet consectetur adipisicing elit. Ipsum non facilis corporis modi consequatur. Iure perferendis dicta illum deleniti veritatis vero tempora maxime ducimus quaerat, iusto omnis magni doloribus. Repellat exercitationem odio rerum doloremque quod, enim iste doloribus fugit incidunt suscipit, totam illo molestias! Beatae error reprehenderit autem ex sit laudantium praesentium quibusdam optio, ab omnis magnam nobis quisquam enim ad sint? Error soluta exercitationem earum atque</p>
                                    <p>Lorem ipsum dolor, sit, amet consectetur adipisicing elit. Modi, id. Doloremque nobis eaque cum excepturi ratione natus ex architecto neque, facilis repudiandae, quod repellendus, minima porro, exercitationem quas recusandae consequatur!</p>
                                </div>
                            </div>
                            <div class="tab-pane fade" id="tab_2" role="tabpanel">
                                <div class="row gx-5">
                                    <div class="col-lg-6">
                                        <div class="post-comment-wrap mb-0">
                                            <h4 class="comment-title">2 Reviews</h4>
                                            <div class="comment-item">
                                                ...
                                                <div class="comment-author_text">
                                                    ...
                                                    <p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor voluptua. At vero eos et accusam et justo duo dolores et ea rebum.</p>
                                                </div>
                                            </div>
                                            <div class="comment-item">
                                                <div class="comment-author_img">
                                                ...
                                                <div class="row gx-3">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="checkbox">
                                                            ...
                                                            <label for="ts">I Agree With Your Trams & Conditions.</label>
                                                        </div>
                                                        <button href="#" class="btn v1">Submit <i class="ri-logout-circle-r-line"></i> </button>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
